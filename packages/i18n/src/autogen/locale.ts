...
export interface Locale extends ILocale {
    ...
    /**
     * このサーバーは<b>Misskey</b>または<b>EgoKey v4.3.0以前</b>のバージョンから移行されました。
    ...
    /**
     * ノート編集に対応しているソフトウェア<small>（Mastodon、EgoKey、FireFishなど）</small>でのみ、編集された内容と履歴を見ることができます。
    ...
    /**
     * ようこそ！EgoKeyは、オープンソースの分散型マイクロブログサービスです。
    ...
    "introMisskey": string;
    /**
     * {name}は、オープンソースのプラットフォーム<b>EgoKey</b>のサーバーのひとつです。
     */
    ...
    /**
     * EgoKeyを自分でインストールした場合は、設定ファイルに入力したパスワードを使用してください。
     * EgoKeyのホスティングサービスなどを使用している場合は、提供されたパスワードを使用してください。
    ...
    "flagAsBot": string;
    /**
     * このアカウントがプログラムによって運用される場合は、このフラグをオンにします。オンにすると、反応の連鎖を防ぐためのフラグとして他の開発者に役立ったり、EgoKeyのシステム上での扱いがBotに合ったものになります。
     */
    ...
    "scratchpad": string;
    /**
     * スクラッチパッドは、AiScriptの実験環境を提供します。EgoKeyと対話するコードの記述、実行、結果の確認ができます。
     */
    ...
    "private": string;
    /**
     * EgoKeyは有志によって様々な言語に翻訳されています。{link}で翻訳に協力できます。
     */
    ...
    /**
     * オンにすると、問題が発生したときにエラーの詳細情報がEgoKeyに共有され、ソフトウェアの品質向上に役立てることができます。エラー情報には、OSのバージョン、ブラウザの種類、行動履歴などが含まれます。
     */
    ...
    /**
     * EgoKeyを気に入っていただけましたか？
     */
    "didYouLikeMisskey": string;
    /**
     * EgoKeyは{host}が使用している無料のソフトウェアです。これからも開発を続けられるように、ぜひ寄付をお願いします！
     */
    ...
    /**
     * ソースコードが公開されているリポジトリがある場合、そのURLを記入します。EgoKeyを現状のまま（ソースコードにいかなる変更も加えずに）使用している場合は https://github.com/anxrch/egokey と記入します。
     */
    ...
    "_initialAccountSetting": {
        ...
        /**
         * このまま{name}(EgoKey)の使い方についてのチュートリアルに進むこともできますが、ここで中断してすぐに使い始めることもできます。
         */
    ...
    "_initialTutorial": {
        ...
        "_note": {
            ...
            "title": string;
            /**
             * EgoKeyでの投稿は「ノート」と呼びます。ノートはタイムラインに時系列で並んでいて、リアルタイムで更新されていきます。
             */
            "description": string;
            /**
        ...
        "_timeline": {
            ...
            "title": string;
            /**
             * EgoKeyには、使い方に応じて複数のタイムラインが用意されています（サーバーによってはいずれかが無効になっていることがあります）。
             */
            "description1": string;
            /**
        ...
        "_postNote": {
            ...
            "title": string;
            /**
             * EgoKeyにノートを投稿する際には、様々なオプションの設定が可能です。投稿フォームはこのようになっています。
             */
            "description1": string;
            "_visibility": {
                /**
        ...
        "_done": {
            ...
            "title": string;
            /**
             * ここで紹介した機能はほんの一部にすぎません。EgoKeyの使い方をより詳しく知るには、{link}をご覧ください。
             */
    ...
    "_accountMigration": {
         ...
         *
         * （この説明はこのサーバー（EgoKey v13.12.0以降）の仕様です。Mastodonなどの他のActivityPubソフトウェアでは挙動が異なる場合があります。）
         */
    ...
    "_achievements": {
        ...
        "_types": {
            ...
            "_iLoveCherryPick": {
                ...
                "description": string;
                /**
                 * EgoKeyを使ってくださりありがとうございます！ by 開発チーム
                 */
                "flavor": string;
            };
            "_foundTreasure": {
    ...
    "_aboutMisskey": {
        /**
         * EgoKeyは、Misskeyをベースに2021年から開発中のカスタマイズオープンソースのソフトウェアです。
         */
        "about": string;
        /**
         * コントリビューター
        ...
        "original": string;
        /**
         * {name}はオリジナルのEgoKeyを改変したバージョンを使用しています。
         */
    ...
    "_mfc": {
        ...
        "cheatSheet": string;
        /**
         * MFCは、EgoKey内の様々な場所で使用できる専用のマークアップ言語です。ここでは、MFCで使用可能な構文一覧が確認できます。
         */
        "intro": string;
        /**
         * EgoKeyでFediverseの世界が広がります
         */
        "dummy": string;
        /**
         * メンション
    ...
    "_soundSettings": {
        ...
        /**
         * 長い音声を使用するとEgoKeyの使用に支障をきたす可能性があります。それでも続行しますか？
         */
    ...
    "_urlPreviewSetting": {
        ...
        "summaryProxy": string;
        /**
         * EgoKey本体ではなく、サマリープロキシを使用してプレビューを生成します。
         */
    ...
    "_selfXssPrevention": {
        ...
        "description2": string;
        /**
         * 貼り付けようとする項目が何なのか正確に理解しているのであれば、私たちと一緒にEgoKeyを開発するのはいかがでしょうか？ {link}
         */
        "description3": ParameterizedString<"link">;
        /**
    ...
    "_search": {
        ...
        /**
         * 例: egokey.example.com
         */
        "serverHostPlaceholder": string;
    };
    "_serverSetupWizard": {
        /**
         * EgoKeyのインストールが完了しました！
         */
        ...
        "_donationRequest": {
            /**
             * EgoKeyは有志によって開発されている無料のソフトウェアです。
             */
            "text1": string;
            /**
    ...
    "_keyboardShortCut": {
        ...
        "_postForm": {
            ...
            /**
             * この機能は「設定 → EgoKey」から該当の機能を有効にすることで利用できます。
             */
            "featureWarn": string;
            /**
             * 投稿する
