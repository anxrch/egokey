...
import { TruncateAccountKeepDriveService } from '@/core/TruncateAccountKeepDriveService.js';
...
export default class extends Endpoint<typeof meta, typeof paramDef> { // eslint-disable-line import/no-default-export
  constructor(
    ...
    private truncateAccountKeepDriveService: TruncateAccountKeepDriveService,
  ) {
