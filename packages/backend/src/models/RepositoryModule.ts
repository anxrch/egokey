...
const $noteRevisionsRepository: Provider = {
	provide: DI.noteRevisionsRepository,
	useFactory: (db: DataSource) => db.getRepository(MiNoteRevision).extend(miRepository as MiRepository<MiNoteRevision>),
	inject: [DI.db],
};
