...
export const Square = {
	...
	args: {
		...
		specify: {
			...
			place: 'square',
			imageUrl:
				'https://github.com/anxrch/egokey/blob/main/packages/frontend/assets/about-icon.png?raw=true',
		},
	},
} satisfies StoryObj<typeof MkAd>;
export const Horizontal = {
	...
	args: {
		...
		specify: {
			...
			place: 'horizontal',
			imageUrl:
				'https://github.com/anxrch/egokey/blob/main/packages/frontend/assets/fedi.jpg?raw=true',
		},
	},
} satisfies StoryObj<typeof MkAd>;
