...
export type NotesRenoteMutingCreateRequest = operations['notes___renote-muting___create']['requestBody']['content']['application/json'];
export type NotesRenoteMutingDeleteRequest = operations['notes___renote-muting___delete']['requestBody']['content']['application/json'];
