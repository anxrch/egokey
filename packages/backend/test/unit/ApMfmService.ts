...
describe('ApMfmService', () => {
	...
	describe('getNoteHtml', () => {
		test('Do not provide _misskey_content for simple text', () => {
			...
			assert.equal(content, 'テキスト <a href="http://egokey.local/tags/%E3%82%BF%E3%82%B0" rel="tag">#タグ</a> <a href="http://egokey.local/@mention" class="u-url mention">@mention</a> 🍊 ​:emoji:​ <a href="https://example.com/">https://example.com</a>', 'content');
		});
