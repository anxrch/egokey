...
<div class="_gaps_m">
	...
	<FormSection>
		<div class="_gaps_m">
			...
			<FormLink v-if="instance.repositoryUrl || instance.providesTarball" :to="instance.repositoryUrl || `/tarball/egokey-${version}.tar.gz`" external>
