...
export type ITruncateAccountKeepDriveRequest = operations['i___truncate-account-keep-drive']['requestBody']['content']['application/json'];
...
export type NotesEditHistoryRequest = operations['notes___edit-history']['requestBody']['content']['application/json'];
export type NotesEditHistoryResponse = operations['notes___edit-history']['responses']['200']['content']['application/json'];
