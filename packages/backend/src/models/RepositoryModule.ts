...
const $noteRenoteMutingsRepository: Provider = {
	provide: DI.noteRenoteMutingsRepository,
	useFactory: (db: DataSource) => db.getRepository(MiNoteRenoteMuting).extend(miRepository as MiRepository<MiNoteRenoteMuting>),
	inject: [DI.db],
};
