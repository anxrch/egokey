...
import { MiNoteRenoteMuting } from '@/models/NoteRenoteMuting.js';
...
export type NoteRenoteMutingsRepository = Repository<MiNoteRenoteMuting> & MiRepository<MiNoteRenoteMuting>;
