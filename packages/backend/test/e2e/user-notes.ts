...
describe('users/notes', () => {
	...
	beforeAll(async () => {
		...
		const jpg = await uploadUrl(alice, 'https://raw.githubusercontent.com/anxrch/egokey/main/packages/backend/test/resources/192.jpg');
		const png = await uploadUrl(alice, 'https://raw.githubusercontent.com/anxrch/egokey/main/packages/backend/test/resources/192.png');
