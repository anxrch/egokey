...
// @public (undocumented)
type ITruncateAccountKeepDriveRequest = operations['i___truncate-account-keep-drive']['requestBody']['content']['application/json'];
