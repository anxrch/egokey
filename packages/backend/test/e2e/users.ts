...
import { api, ensureNoteEditMetadata, post, role, signup, successfulApiCall, uploadFile } from '../utils.js';
...
describe('ユーザー', () => {
    ...
    beforeEach(async () => {
        ...
        aliceNote = ensureNoteEditMetadata(await successfulApiCall({ endpoint: 'notes/show', parameters: { noteId: aliceNote.id }, user: alice }));
    });
